...
Reference FDM (Present, $251\times 251$) & 0.5440 & 0.5760 & -0.0873 & 0.8720 & 0.1160 & 0.986 \\
$\psi\text{--}p$ PINN (Proposed) & 0.5418 & 0.5819 & -0.0864 & 0.8863 & 0.1639 & 2.216 \\
$\psi\text{--}\omega$ PINN (Coupled) & 0.5452 & 0.5953 & -0.0873 & 0.8796 & 0.1304 & 0.845 \\
\bottomrule
\end{tabular}
\end{table}
